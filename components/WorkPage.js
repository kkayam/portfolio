    ...
    return (
        <>
            <div className={styles.section}>
                <div className={styles.sectionTitle}>Chromaway</div>
            ...
            <div className={styles.section}>
                <div className={styles.sectionTitle}>KTH</div>
                Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. In consequat ac libero sit amet tincidunt. In vitae nunc massa. Quisque a sem sed metus fermentum placerat ut eget quam. Sed at turpis tempus, malesuada nulla eget, fringilla est. Maecenas at nisi hendrerit, vehicula urna quis, iaculis nulla. Donec in tortor ac sem suscipit aliquam nec id ante. Phasellus aliquam blandit est eget pulvinar. Curabitur commodo enim non imperdiet sollicitudin. Proin malesuada at sapien non pretium.
            </div>
        </>);
}